    ...
    <>
      ...
      <div className="dashboard-left">
        ...
        <div className="results__note">
          ...
          <span>On-chain data only. Install the <a href="https://github.com/amanpatel1208/dex-risk-extension" target="_blank" rel="noopener noreferrer">extension</a> for live metrics.</span>
        </div>
